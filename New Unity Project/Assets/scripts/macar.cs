...
{
    public class macar : MonoBehaviour
    {
        /// <summary>
        /// Contains parameters that can adjust the car's behaviors temporarily.
        /// </summary>
        [System.Serializable]
        public class StatPowerup
        {
            public macar.Stats modifiers;
        ...
        /// <summary>
        /// Contains a series tunable parameters to tweak various car's for unique driving mechanics.
        /// </summary>
        [System.Serializable]
        public struct Stats
        {
            ...
            [Tooltip("How much the car tries to keep going forward when on bumpy terrain.")]
            [Range(0, 1)]
        ...
        public macar.Stats baseStats = new macar.Stats
        {
            TopSpeed = 10f,
            Acceleration = 5f,
        ...
        [Tooltip("The transform that determines the position of the car's mass.")]
        public Transform CenterOfMass;

        [Tooltip("The physical representations of the car's wheels.")]
