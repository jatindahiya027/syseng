...
#pragma warning restore CS0414
        ...
        private void HandleScreenshot() {
            ...
            if (screenshotFormat == ImageFormat.PNG) 
                File.WriteAllBytes(screenshotPath + name + ".png", ImageConversion.EncodeToPNG(screenshotBuffer));
            else if (screenshotFormat == ImageFormat.JPG)
                File.WriteAllBytes(screenshotPath + name + ".jpg", ImageConversion.EncodeToJPG(screenshotBuffer, screenshotQuality));
#if UNITY_5_6_OR_NEWER
            else
                File.WriteAllBytes(screenshotPath + name + ".exr", ImageConversion.EncodeToEXR(screenshotBuffer, screenshotExr32 ? Texture2D.EXRFlags.OutputAsFloat : Texture2D.EXRFlags.None));
#endif
